...
My research interests lie at the intersection of **AI evaluation, deployment, and blockchains**. I aim to leverage technology to promote fairness and transparency in the AI era, with a strong focus on real-world impact. I have contributed to the technical foundation (whitepaper) of high-profile startups including [Sentient](https://sentient.foundation), [Kite AI](https://gokite.ai/), and [PolyHedra](https://polyhedra.network/research/).
